...
const SignUpForm = (props) => {
  ...
  const formSubmitHandler = async (event) => {
    ...
    const url = `http://localhost:3003/users/add-user`;
    ...
    <section className="w-full flex xl:flex-row flex-col justify-center gap-10 max-container pt-16 pb-20 bg-white">
      ...
      >
        <div className="flex flex-col justify-center pt-5 ">
          ...
          <input
            className={`border-solid ${nameInputClass} border-2 rounded-md items-center px-10 py-3 `}
            type="name"
            id="name"
            name="name"
        ...
        <div className="flex flex-col justify-center pt-5">
          ...
          <input
            className={`border-solid ${emailInputClass} border-2 rounded-md items-center px-10 py-3`}
            type="email"
            id="email"
            name="email"
        ...
        <div className="flex flex-col justify-center pt-5">
          ...
          <input
            className={`border-solid ${passwordInputClass} border-2 rounded-md items-center px-10 py-3`}
            type="password"
            id="password"
            name="password"
